<div id="body" class="livros_container">
	<div id="body_inner">
		...
		<div id="livros">
			<h1>Meus livros disponíveis para troca</h1>

			<ul class="bookshelf">
				<?php
					foreach($books as $book) {
				        echo "<li id=\"".$book->id_livro."\" data-type='1' data-view='1'>"
									 .img(array('src'=>'assets/imgs/book_covers/'.$book->foto))
									 ."<p class='booktag'>EDITAR</p>"
		...
		<div id="livros_cadastro">
			<h1>Adicionar livro para troca</h1>
			...
			<?php echo form_open_multipart('estante/inserir', 'id="cadastro_livros"'); ?>
				<input type="hidden" id="data-view" value="1" />
